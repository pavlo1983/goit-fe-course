...
class Hamburger {
  ...
  get calculatePrice() {
    const pricesArr = this._toppings.map(x => Hamburger.TOPPINGS[x].price);
    pricesArr.push(
      Hamburger.SIZES[this._size].price,
      Hamburger.STUFFINGS[this._stuffing].price
    );
    let totalPrice = pricesArr.reduce((acc, prices) => acc + prices, 0);
    return totalPrice;
  }
  ...
  get calculateCalories() {
    ...
    let totalCalories = caloriesArr.reduce(
