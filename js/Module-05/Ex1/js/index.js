...
const getUsersByEyeColor = (arr, color) =>
  arr.filter(arr => color === arr.eyeColor);
...
const getUsersByGender = (arr, gender) =>
  arr.filter(arr => gender === arr.gender).map(arr => arr.name);
 ...
 */
const getUserByEmail = (arr, email) => arr.find(arr => email === arr.email);
...
const getUsersWithAge = (arr, min, max) =>
  arr.filter(arr => arr.age > min && arr.age < max);
...
const getUsersByFriend = (arr, name) =>
  arr.filter(arr => arr.friends.includes(name)).map(arr => arr.name);
